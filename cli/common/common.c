...
#define OPT2(STR0, STR1) else if( !strcmp( name, STR0 ) || !strcmp( name, STR1 ) )
    ...
    OPT("stats")
    {
        p->rc.psz_stat_in = _strdup(value);
        p->rc.psz_stat_out = _strdup(value);
    }
    OPT("qcomp")
    ...
    OPT("opencl-clbin")
        p->psz_clbin_file = _strdup( value );
    OPT("opencl-device")
